 ...
 */
$string['pluginname']='Learner adaptation'; // Name to display for format
...
$string['formatilms']='Adaptive iLMS Course'; // Name to display for format
$string['nameilms']='Section'; // Name of a section within your format
...
// TODO Translate the feedback comments into English
